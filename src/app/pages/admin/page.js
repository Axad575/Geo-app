  ...
  return (
    ...
    <div className={`flex ${isLight ? 'bg-white' : 'bg-gray-800'}, ${isDark ? 'bg-gray-700 text-white' : 'bg-white'}`}>
      <nav className="w-1/5 h-screen bg-gray-800 text-white p-4">
        ...
        <ul className="mt-10">
          <li className="mb-4">
            <button onClick={usersPage} className="w-full text-left px-4 py-2 bg-gray-700 rounded">Users</button>
          </li>
          <li className="mb-4">
      ...
      <div className="flex-1">
        ...
        <div className="grid justify-center mt-4">
          ...
          <div className="grid w-11/12 m-12 p-7 rounded-xl bg-slate-500">
              <p className="font-sans font-semibold text-2xl">About Geo-app's Admin</p>
              <p className="font-sans mt-2">Geo-app's admin panel is designed to provide administrators with comprehensive control over the application's various aspects. It offers an intuitive interface for managing users, projects, chats, and news. The panel includes features such as dark mode and language settings, ensuring a customizable and user-friendly experience. Administrators can easily navigate through different sections, perform essential tasks, and maintain the overall functionality and security of the application.</p>
          </div>
        </div>
      </div>
    </div>
