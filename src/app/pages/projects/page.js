    ...
    <div className={`flex ${isLight ? 'bg-white' : 'bg-gray-800'}, ${isDark ? 'bg-gray-700 text-white' : 'bg-white'}`}>
      ...
      <div className="flex-1">
        ...
        <div className="grid justify-center mt-4">
          <h1 className="font-sans font-semibold text-4xl text-center">Projects</h1>
          <div className="grid w-11/12 m-12 p-7 rounded-xl">
          <div>
                  {proj.map((article, index) => (
                    <div key={index} className={`bg-gray-100 p-4 mb-4 rounded shadow ${isDark ? 'bg-gray-300 text-black' : 'bg-white'}`}>
                      ...
                      <p className="text-gray-500 text-sm">Status {article.status}</p>
                      <p className="text-gray-500 text-sm">Start: {article.startDate}</p>
                      <p className="text-gray-500 text-sm">End: {article.endDate}</p>
                    </div>
                  ))}
                </div>
          </div>
